...
//
// Local configuration for the beken_robot Bluetooth A2DP music +
// hand-rhythm feature.
#pragma once
...
/* Bluetooth device name advertised to the phone (suffixed with the last 3
 * MAC bytes at runtime in bt_music.c). */
#define LOCAL_NAME "beken_robot"

#define A2DP_SINK_DEMO_TASK_PRIORITY      (4)

#define CONFIG_A2DP_CACHE_FRAME_NUM    4

#define DEFAULT_A2DP_VOLUME  0x30
