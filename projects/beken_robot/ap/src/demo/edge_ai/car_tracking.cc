...
#define CAR_TRACKING_SERVO_DURATION_MS_DEFAULT    10000.0f
#define CAR_TRACKING_SERVO_STOP_DURATION_MS_DEFAULT 20.0f
#define CAR_TRACKING_SERVO_DEADZONE_PX_DEFAULT    20.0f
#define CAR_TRACKING_SERVO_START_DEADZONE_PX_DEFAULT 40.0f
#define CAR_TRACKING_SERVO_STOP_SETTLE_MS_DEFAULT 300U
#define CAR_TRACKING_GESTURE_TARGET_SIZE_PX_DEFAULT     120.0f
#define CAR_TRACKING_GESTURE_SIZE_DEADZONE_PX_DEFAULT   15.0f
#define CAR_TRACKING_CHASSIS_SPEED_DEFAULT              100.0f
#define CAR_TRACKING_CHASSIS_TURN_RATE_DEFAULT          0.5f
