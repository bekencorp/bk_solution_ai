...
typedef enum
{
    ...
    APP_EVT_AI_SPEAKING,
    APP_EVT_AI_IDLE,
    APP_EVT_FACE_NO_FACE_DETECTED,
    APP_EVT_FACE_ENROLLMENT_FAILED,
    APP_EVT_FACE_ENROLLMENT_SUCCESSFUL,
    APP_EVT_FACE_ENROLLMENT_COMPLETED,
    APP_EVT_FACE_VERIFICATION_PASSED,
    APP_EVT_FACE_VERIFICATION_FAILED,
    APP_EVT_FACE_ENROLLMENT_REQUIRED,
    APP_EVT_FACE_CLEAR_CONFIRM,
    APP_EVT_FACE_DATABASE_CLEARED,
    APP_EVT_FACE_DELETE_SUCCESS,
    APP_EVT_FACE_DELETE_FAILED,
    APP_EVT_FACE_NO_DELETABLE_PROFILE,
