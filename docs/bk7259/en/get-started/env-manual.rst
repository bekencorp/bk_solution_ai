...
- Manual installation:
    ...
    Please refer to `SMP documentation: Manual installation <https://docs.bekencorp.com/arminodoc/bk_avdk_smp/smp_doc/bk7259/en/v4.0.1/get-started/manual_install.html>`_ for manual installation.


.. note::

    The default toolchain path for the AP is defined in ``ap/middleware/soc/bk7259_ap/soc_config.mk``, and the default toolchain path for the CP is defined in ``cp/middleware/soc/bk7259/soc_config.mk``. You can also change the toolchain path in the project file ``pj_config.mk``::
...
Run following commands to build BK7259 app project::
...
For more compilation-related commands, please refer to `SMP documentation: Build overview <https://docs.bekencorp.com/arminodoc/bk_avdk_smp/smp_doc/bk7259/en/v4.0.1/developer-guide/build_config/bk_build_overview.html>`_
