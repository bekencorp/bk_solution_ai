...
#include "prompt_tone_wav_array.h"
#elif CONFIG_AE_PROMPT_TONE_DECODER_PCM
...
static char network_provision_success_prompt_tone_path[] = "/sd0/network_provision_success_16k_mono_16bit_en.mp3";
static char network_provision_fail_prompt_tone_path[] = "/sd0/network_provision_fail_16k_mono_16bit_en.mp3";
static char reconnect_network_prompt_tone_path[] = "/sd0/reconnect_network_16k_mono_16bit_en.mp3";
static char reconnect_network_success_prompt_tone_path[] = "/sd0/reconnect_network_success_16k_mono_16bit_en.mp3";
static char reconnect_network_fail_prompt_tone_path[] = "/sd0/reconnect_network_fail_16k_mono_16bit_en.mp3";
static char rtc_connection_lost_prompt_tone_path[] = "/sd0/rtc_connection_lost_16k_mono_16bit_en.mp3";
static char agent_joined_prompt_tone_path[] = "/sd0/agent_joined_16k_mono_16bit_en.mp3";
static char agent_offline_prompt_tone_path[] = "/sd0/agent_offline_16k_mono_16bit_en.mp3";
static char low_voltage_prompt_tone_path[] = "/sd0/low_voltage_16k_mono_16bit_en.mp3";
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = asr_wakeup_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)asr_wakeup_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = asr_standby_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)asr_standby_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = network_provision_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)network_provision_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = network_provision_success_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)network_provision_success_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = network_provision_fail_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)network_provision_fail_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = reconnect_network_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)reconnect_network_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = reconnect_network_success_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)reconnect_network_success_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = reconnect_network_fail_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)reconnect_network_fail_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = rtc_connection_lost_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)rtc_connection_lost_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = agent_joined_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)agent_joined_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = agent_offline_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)agent_offline_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = low_voltage_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)low_voltage_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = ota_update_success_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)ota_update_success_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = ota_update_fail_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)ota_update_fail_prompt_tone_array;
...
#if CONFIG_AE_PROMPT_TONE_SOURCE_VFS
            s_event_prompt_tone_info.uri = agent_start_fail_prompt_tone_path;
#endif
#if CONFIG_AE_PROMPT_TONE_SOURCE_ARRAY
            s_event_prompt_tone_info.uri = (char *)agent_start_fail_prompt_tone_array;
            ...
            switch (msg.event)
            {
                ...
                case APP_EVT_IR_MODE_SWITCH:
                    if (is_standby == 0) {
                        ...
                        LOGI("APP_EVT_IR_MODE_SWITCH, is_standby is 1, do nothing\r\n");
                    }
                    break;
#endif
...
#if CONFIG_AE_SUPPORT_PROMPT_TONE && !(CONFIG_A2DP_SINK_DEMO || CONFIG_HFP_HF_DEMO)
